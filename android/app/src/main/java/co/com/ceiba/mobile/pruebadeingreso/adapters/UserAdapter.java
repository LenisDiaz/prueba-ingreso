...
public class UserAdapter extends RecyclerView.Adapter<UserAdapter.ViewHolderUser> implements Filterable {
    ...
    public void onBindViewHolder(@NonNull ViewHolderUser holder, int position) {
        holder.name.setText(usersFiltered.get(position).getNombre());
        ...
        holder.post.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    Log.d("URL POST",Endpoints.URL_BASE + Endpoints.GET_POST_USER + usersFiltered.get(posicion).getId());
                    handler.execute(Endpoints.URL_BASE + Endpoints.GET_POST_USER + usersFiltered.get(posicion).getId(), user).get();
    ...
    private class OkHttpHandler extends AsyncTask<String, Void, byte[]> {
        ...
        protected byte[] doInBackground(String... params) {
            ...
            try {
                ...
                Log.d("RESPONSE POST",responseService);
                user = params[1];
